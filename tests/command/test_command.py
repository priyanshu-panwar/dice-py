...
from dicedb_py.command.command import Command
...
class TestCommand(unittest.TestCase):
    ...
    @patch("dicedb_py.command.executor.Executor._execute_command", return_value="OK")
    ...
    @patch(
        "dicedb_py.command.executor.Executor._execute_command",
    ...
    @patch("dicedb_py.command.executor.Executor._execute_command", return_value="1")
    ...
    @patch("dicedb_py.command.executor.Executor._execute_command", return_value="11")
    ...
    @patch("dicedb_py.command.executor.Executor._execute_command", return_value="9")
    ...
    @patch("dicedb_py.command.executor.Executor._execute_command", return_value="10")
